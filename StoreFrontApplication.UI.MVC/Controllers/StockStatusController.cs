...
namespace StoreFrontApplication.UI.MVC.Controllers
{
    public class StockStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InStockID,Status")] StockStatus stockStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InStockID,Status")] StockStatus stockStatus)
        {
            if (ModelState.IsValid)
            {
